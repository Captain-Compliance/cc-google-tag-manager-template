...

{
  ...
  "description": "Captain Compliance provides a user-friendly platform backed by privacy professionals. We simplify the process of navigating regulations, giving your customers transparent choices and building essential trust for your organization. A Google Consent Mode v2 native CMP, IAB TCF registered. Learn more at https://captaincompliance.com",
  "containerContexts": [
    "WEB"
  ]
}
